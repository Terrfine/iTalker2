...
public class DbHelper {
     ...
     */
    private <Model extends BaseModel> Set<ChangedListener> getListener(Class<Model> modelClass){
    ...
    private <Model extends BaseModel>  void notifySave(final Class<Model> tClass, final Model... models){
        //找监听器
     ...
     */
    @SuppressWarnings("unchecked")
    private <Model extends BaseModel>  void notifyDelete(final Class<Model> tClass, final Model... models){
        //TODO
        //找监听器
        final Set<ChangedListener> listeners = getListener(tClass);
        if(listeners != null && listeners.size()>0){
