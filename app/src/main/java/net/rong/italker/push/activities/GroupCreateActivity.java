...
import net.rong.italker.factory.presenter.group.GroupCreateContract;
import net.rong.italker.factory.presenter.group.GroupCreatePresenter;
...
public class GroupCreateActivity extends PresenterToolbarActivity<GroupCreateContract.Presenter>
    ...
    void onPortraitClick() {
        ...
        new GalleyFragment()
                ...
                }).show(getSupportFragmentManager(), GalleyFragment.class.getName());
    }
